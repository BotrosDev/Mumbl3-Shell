            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            anchors {
                                left: barPositionCombo.currentIndex === 2 || barPositionCombo.currentIndex === 0 || barPositionCombo.currentIndex === 1 ? parent.left : undefined
                                right: barPositionCombo.currentIndex === 3 || barPositionCombo.currentIndex === 0 || barPositionCombo.currentIndex === 1 ? parent.right : undefined
                            ...
                            RowLayout {
                                ...
                                visible: barPositionCombo.currentIndex === 0 || barPositionCombo.currentIndex === 1
                            ...
                            ColumnLayout {
                                ...
                                anchors.margins: 5
                                spacing: spacingSlider.value / 2
                                visible: barPositionCombo.currentIndex === 2 || barPositionCombo.currentIndex === 3
...
ComboBox {
    ...
    // Use a separate property to avoid binding loop
    property int savedIndex: {
        if (Dat.ThemeSettings.barPosition_T === "top") return 0
        if (Dat.ThemeSettings.barPosition_B === "bottom") return 1
        if (Dat.ThemeSettings.barPosition_L === "left") return 2
        if (Dat.ThemeSettings.barPosition_R === "right") return 3
        return 0
    }
    ...
    onActivated: {
        ...
        switch(index) {
            case 0: Dat.ThemeSettings.setBarPosition_T("top"); Dat.ThemeSettings.setBarPosition_L("left"); Dat.ThemeSettings.setBarPosition_R("right"); Dat.ThemeSettings.setBarPosition_B(""); break
            case 1: Dat.ThemeSettings.setBarPosition_B("bottom"); Dat.ThemeSettings.setBarPosition_L("left"); Dat.ThemeSettings.setBarPosition_R("right"); Dat.ThemeSettings.setBarPosition_T(""); break
            case 2: Dat.ThemeSettings.setBarPosition_L("left"); Dat.ThemeSettings.setBarPosition_T("top"); Dat.ThemeSettings.setBarPosition_B("bottom"); Dat.ThemeSettings.setBarPosition_R(""); break
            case 3: Dat.ThemeSettings.setBarPosition_R("right"); Dat.ThemeSettings.setBarPosition_T("top"); Dat.ThemeSettings.setBarPosition_B("bottom"); Dat.ThemeSettings.setBarPosition_L(""); break
        }
    }
}
    ...
    opacity: 0.5
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            onActivated: {
                                if (index >= 0 && index < Dat.Fonts.fontFamilies.length)
                                    Dat.ThemeSettings.setFontFamily(Dat.Fonts.fontFamilies[index])
                            }
                        }
                    }
