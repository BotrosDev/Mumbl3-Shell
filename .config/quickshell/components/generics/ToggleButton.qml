...
Rectangle {
  ...
  property color activeColor: Dat.Colors.color.primary
  property color activeIconColor: Dat.Colors.color.on_primary
  property alias icon: matIcon
  property alias mArea: mouseArea
  property color passiveColor: Dat.Colors.color.surface_container
  property color passiveIconColor: Dat.Colors.color.on_surface
