        ...
        Image {
            ...
            source: {
                ...
                if (level >= 100 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-100-charged.svg"
                } else if (level >= 100) {
                    return "../../theme/images/theme-light/battery-100.svg"
                }
                // 90%
                else if (level >= 90 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-090-charging.svg"
                } else if (level >= 90) {
                    return "../../theme/images/theme-light/battery-090.svg"
                }
                // 80%
                else if (level >= 80 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-080-charging.svg"
                } else if (level >= 80) {
                    return "../../theme/images/theme-light/battery-080.svg"
                }
                // 70%
                else if (level >= 70 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-070-charging.svg"
                } else if (level >= 70) {
                    return "../../theme/images/theme-light/battery-070.svg"
                }
                // 60%
                else if (level >= 60 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-060-charging.svg"
                } else if (level >= 60) {
                    return "../../theme/images/theme-light/battery-060.svg"
                }
                // 50%
                else if (level >= 50 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-050-charging.svg"
                } else if (level >= 50) {
                    return "../../theme/images/theme-light/battery-050.svg"
                }
                // 40%
                else if (level >= 40 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-040-charging.svg"
                } else if (level >= 40) {
                    return "../../theme/images/theme-light/battery-040.svg"
                }
                // 30%
                else if (level >= 30 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-030-charging.svg"
                } else if (level >= 30) {
                    return "../../theme/images/theme-light/battery-030.svg"
                }
                // 20%
                else if (level >= 20 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-020-charging.svg"
                } else if (level >= 20) {
                    return "../../theme/images/theme-light/battery-020.svg"
                    
                }
                // 10%
                else if (level >= 10 && stat === "Charging") {
                    return "../../theme/images/theme-light/battery-010-charging.svg"
                } else if (level >= 10) {
                    return "../../theme/images/theme-light/battery-010.svg"
                }
                // 0%
                else if (stat === "Charging") {
                    return "../../theme/images/theme-light/battery-000-charging.svg"
                } else {
                    return "../../theme/images/theme-light/battery-000.svg"
                }
            }
        }
